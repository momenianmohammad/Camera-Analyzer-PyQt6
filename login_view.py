...
class LoginView(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.labelMsg.setGeometry(QRect(widgets_width_pos, widgets_height_pos - 18*(widgets_height - widgets_height//2) , widgets_width, widgets_height))
        self.comboBox_type = QComboBox(self.frame)
        self.comboBox_type.setEnabled(False)
        self.comboBox_type.setGeometry(QRect(widgets_width_pos, widgets_height_pos - 15*(widgets_height - widgets_height//2), widgets_width, widgets_height))
        ...
        self.comboBox_brand.setGeometry(QRect(widgets_width_pos, widgets_height_pos - 13*(widgets_height - widgets_height//2), widgets_width, widgets_height))
        self.comboBox_brand.setObjectName("comboBox_brand")
        self.comboBox_brand.addItem("")
        self.lineEdit_ip = QLineEdit(self.frame)
        self.lineEdit_ip.setGeometry(QRect(widgets_width_pos, widgets_height_pos - 10*(widgets_height - widgets_height//2), widgets_width , widgets_height))
        self.lineEdit_ip.setObjectName("textEdit_ip_address")
        self.lineEdit_user = QLineEdit(self.frame)
        self.lineEdit_user.setGeometry(QRect(widgets_width_pos, widgets_height_pos - 7*(widgets_height - widgets_height//2), widgets_width, widgets_height))
        self.lineEdit_user.setObjectName("textEdit_user")
        self.lineEdit_password = QLineEdit(self.frame)
        self.lineEdit_password.setGeometry(QRect(widgets_width_pos, widgets_height_pos - 4*(widgets_height - widgets_height//2), widgets_width, widgets_height))
    ...
    def deleteLoginLayout(self):
        ...
        self.labelIrost.setParent(None)
